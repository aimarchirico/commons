...
/**
 * Exercises the `no.chirico.commons.convention.mapstruct` precompiled script plugin end to end,
 * since its kapt and dependency wiring only runs once a project applies it against a real `libs`
 * version catalog.
 */
