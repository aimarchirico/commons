...
1. Preflight: Verify that `.github/CONTRIBUTING.md` exists and the
   `.github/ISSUE_TEMPLATE/` directory exists. If any are missing, run
   `npx @aimarchirico/commons-github materialize-templates` to materialize the documentation.
...
3. Map and format the identified work strictly following the hierarchy and
   conventions defined in `CONTRIBUTING.md#issues` and
   `.github/ISSUE_TEMPLATE/`. Automatically infer any required logical child
